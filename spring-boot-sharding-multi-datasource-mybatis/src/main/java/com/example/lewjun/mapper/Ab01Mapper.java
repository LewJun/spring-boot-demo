...
public interface Ab01Mapper {
    ...
    @Select("select ab01.*, ac01.* from ab01 as ab01 left join ac01 as ac01 on ab01.aab001 = ac01.aac006")
    @ResultMap("com.example.lewjun.mapper.Ab01Mapper.Ab01Ac01ResultMap")
